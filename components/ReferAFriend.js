            ...
            <View style={Styles.flex1}>
                ...
                <ScrollView style={[Styles.flex1, ]}>
                    <View style={[Styles.alignCenter, Styles.padV20]}>
                        <Text
                            style={[Styles.ffMbold,Styles.pBtm18,Styles.txtAlignCen, Styles.f18]}>
                    ...
                    <View style={[Styles.m20]}>
                        <View style={[Styles.row, Styles.jSpaceBet, Styles.mBtm10]}>
                            <Text style={[Styles.f18,Styles.ffMbold]}>Invite Link</Text>
                            <TouchableOpacity onPress={()=>this.copyInviteLink(this.state.referralData)}>
                                <Text style={[Styles.f16,Styles.ffMregular, {
                        ...
                        <View style={styles.input}>
                            <Text
                                style={[styles.f25, styles.cBlk,Styles.ffMregular]}>{this.state.referralData}</Text>
                        </View>
