...
export default class CashClosure extends React.Component {
    ...
    onBack = () => {
        console.log('reached back start')
        if (this.state.createCashClosureModal) {
            console.log('into ifff')
            return this.props.navigation.navigate('CashClosure');
        }else {
    ...
    returnCreateCashClosureDetails(){
        const {
            selectedCard,
            canEditTextInput,
            noteDenominationList,
                                        ...
                                        <TouchableOpacity
                                            ...
                                            <View pointerEvents='none'>
                                                <TextInput
                                                    ...
                                                    style={[Styles.cBlk, Styles.f16, Styles.ffMbold, Styles.bw1, Styles.bcGrey,Styles.tInputH40]}
                                                ...
                                                <Text
                                                    ...
                                                    <View
                                                        ...
                                                        <View style={[Styles.row, Styles.aslCenter]}>
                                                            <RadioButton.Android disabled={!canEditTextInput} value={'YES'}
                                                                         status={this.state.amountDepositAtBank === 'YES'?'checked' : 'unchecked'}
                                                                         onPress={()=>{this.setState({amountDepositAtBank:'YES'})}}/>
                                                            <Text
                                                                style={[Styles.ffLBlack, Styles.padH5, Styles.aslCenter, Styles.f16]}>Yes</Text>
                                                        </View>
                                                        <View style={[Styles.row, Styles.aslCenter]}>
                                                            <RadioButton.Android disabled={!canEditTextInput} value={'NO'}
                                                                         status={this.state.amountDepositAtBank === 'NO'?'checked' : 'unchecked'}
                                                                         onPress={()=>{this.setState({amountDepositAtBank:'NO'})}}/>
                                                            <Text
                                                            ...
                                                            <View>
                                                                ...
                                                                <View>
                                                                    ...
                                                                    <TouchableOpacity
                                                                        ...
                                                                        <MaterialIcons style={[Styles.pLeft5]} name="timer" size={28} color="#000" />
                                                                    </TouchableOpacity>
                                                                </View>
                                                            </View>
                                                            {/*DEPOSITED IMAGE*/}
    ...
    returnFiltersSearchView(){
        ...
        return(
            <View style={[[Styles.flex1, Styles.bgLBlueWhite]]}>
                <View style={[[Styles.flex1, Styles.bgLBlueWhite]]}>
                    <Appbar.Header style={[Styles.bgDarkRed, Styles.padV5]}>
    ...
    render() {
        ...
        let tempData = selectedCard === 'OPENING_AMOUNT' ? openingDenominationList :
        ...
        return (
            <View style={[Styles.flex1, Styles.bgWhite]}>
                ...
                {
                    this.state.createCashClosureModal
                    ?
                        this.returnCreateCashClosureDetails()
                        :
                    this.returnFiltersSearchView()
                }
                                                        ...
                                                        let renderedDenomination = selectedCard === 'OPENING_AMOUNT' ? openingDenominationList :
                                                            selectedCard === 'DEPOSITED_AMOUNT' ? depositedDenominationList :
                                                                selectedCard === 'CLOSING_AMOUNT' ? closingDenominationList :
                                                                    selectedCard === 'COD_AMOUNT' ? cashCollectedDenominationList : []
                                                        return (
                                                            <View style={[Styles.m3, Styles.row, Styles.jSpaceBet, Styles.marH10]}>
                        ...
                        this.state.showTimepicker === true
                            ...
                            <RNDateTimePicker
                                ...
                                onChange={(event, date) => {
                                    this.setState({
                                        showTimepicker: false,
                                        StartTime: Services.returnCalculatedHours(date),
                                        StartTimeMin: Services.returnCalculatedMinutes(date)
                                    })
                                    // if (event.type === "set") {
                                    //     let tempTime = date
                                    //     this.setState({
