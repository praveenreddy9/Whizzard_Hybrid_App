...
export default class CreateShift extends React.Component {
    ...
    validateDateSelection=(date)=>{
        ...
        if (this.state.pickerMode === 'time'){
            ...
            var filterFromDate = Services.returnCalendarFormat(shiftDate);
                    ...
                    <View style={[Styles.marV5]}>
                        ...
                        <Card style={[styles.shadowCard]}>
                            <Card.Title
                                        ...
                                        titleStyle={[Styles.f18, Styles.ffMbold]}
                                        rightStyle={[Styles.marH10]}
                                        right={() => <MaterialIcons name="timer" size={35} color="#000"
                                                                    onPress={() => this.setState({pickerMode:'time',showDateTimepicker:true})}/>
                            }
                            />
                        </Card>
                        {/*{*/}
                        ...
                        {/*    ?*/}
                        {/*        <DatePicker*/}
                        {/*            date={new Date(this.state.shiftDate)}*/}
                        {/*            mode={this.state.pickerMode}*/}
                        {/*            modal={true}*/}
                        {/*            open={this.state.showDateTimepicker}*/}
                        {/*            minimumDate= {new Date()}*/}
                        {/*            onConfirm={(date)=>{this.validateDateSelection(date)}}*/}
                            ...
                            this.state.showDateTimepicker === true
                                ...
                                <RNDateTimePicker
                                    ...
                                    onChange={(event, date) => {
                                        ...
                                        // }
                                        this.validateDateSelection(date)
                                    }}
                                />
                                :
                                null
                    ...
                    <Card
                        ...
                        <TouchableOpacity onPress={() => this.setState({userRolePopup: true})}>
                            <Card.Title
                                ...
                                right={() =>
                                    <View style={[Styles.row, {paddingRight: 10}]}>
                                        <MaterialIcons name="keyboard-arrow-down" size={40}/>
                                    </View>
                                }
                            />
                        </TouchableOpacity>
