    ...
    activityList(item) {
        ...
        return (
            <Card
                ...
                style={[Styles.bgWhite, styles.shadow, {
                marginBottom: 15,
                borderRadius: 0,
                padding: 5,
                borderWidth: 1,
        ...
        return (
            this.state.totalShiftsInfo
                ...
                <View style={[[Styles.flex1, Styles.bgWhite, {width: Dimensions.get('window').width}]]}>
                    ...
                    <View style={[Styles.bgWhite]}>
                        <Appbar.Header style={Styles.bgDarkRed}>
                            ...
                            <View
                                ...
                                <Fontisto name={showAdhocShifts ? "toggle-on" : "toggle-off"}
                    ...
                    {
                        this.state.filterByRole === true && (this.state.ProfileTab === 'Team'
                            // || this.state.ProfileTab === 'Map'
                        )
                            ?
                            <Card
                    ...
                    <Modal
                        ...
                        <View style={[Styles.headerWithOutBg]}>
                            ...
                            <View
                                ...
                                <TouchableOpacity style={[Styles.p10, Styles.bgDash,Platform.OS === 'ios' ? Styles.br0 : Styles.br100, Styles.aslCenter]}>
                                ...
                                <TouchableOpacity
                                    style={[Styles.bgDash,Platform.OS === 'ios' ? Styles.br0 : Styles.br100, Styles.aslCenter, Styles.marV10]}>
                                ...
                                <TouchableOpacity
                                    style={[Styles.bgDash,Platform.OS === 'ios' ? Styles.br0 : Styles.br100, Styles.aslCenter]}>
