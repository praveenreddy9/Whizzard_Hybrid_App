...
TripsVerification extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            tollBillDetailsUpdated: false,
            vehicleChangeDetailsUpdated:false,
            ...
            vehicleMappingList:[],vehicleMappingSelectionModal:false,
    ...
    //API to get vehicles list based on siteId
    getSiteMappedVehiclesList(userId,shiftId,siteId,tripId) {
        const self = this;
        const apiURL = Config.routes.BASE_URL + Config.routes.GET_VEHICLES_FOR_SITE_MAPPED + 'siteId='+ siteId +'&userId='+ userId + '&shiftId='+shiftId + '&tripId='+tripId + '&forShiftFlow=false';
        const body = {}
        this.setState({spinnerBool: true}, () => {
            Services.AuthHTTPRequestForShiftFlow(apiURL, "GET", body, (response) => {
                if (response.status === 200) {
                    ...
                    self.setState({
                        spinnerBool: false,
                        vehicleMappingList:responseList,
                        vehicleMappingSelectionModal:true
                    });
                }
            }, (error) => {
                self.errorHandling(error)
    ...
    clearUpdatedValues(statusCheck) {
        ...
        return (
            this.setState({
                ...
                tempVehicleVerificationImageUrl: '',
                tempVehicleVerificationImageFormData: '',
                tollBillDetailsUpdated:testValue,
                vehicleChangeDetailsUpdated:testValue
            })
        )
    }
            ...
            Services.AuthHTTPRequestForShiftFlow(apiURL, "PUT", body, (response) => {
                if (response.status === 200) {
                    ...
                    self.setState({
                        ...
                        Utils.dialogBox("Trip Rejected Successfully", '');
    ...
    updateAndVerifyTrip(tripId) {
        ...
        let tempBody = {
            ...
            "vehicleId": selectedCardTripDetails.vehicleId,
            "vehicleRegNumber": selectedCardTripDetails.vehicleRegNumber,
        }
            ...
            Services.AuthHTTPRequestForShiftFlow(apiURL, "PUT", body, (response) => {
                if (response.status === 200) {
                    ...
                    self.setState({
                        ...
                        self.clearUpdatedValues(false)
                        Utils.dialogBox("Trip Verified Successfully", '');
                        if (tempNextCard === self.state.cards.length) {
                            if (!self.state.swipedCurrentCard) {
                                self.swipeRight()
                            }
                ...
                // console.log('update api error==>',error,error.response.data)
                self.errorHandling(error)
            })
        });
    };
    ...
    renderCard = (card, index) => {
        ...
        const {
            ...
            tollBillDetailsUpdated,
            vehicleChangeDetailsUpdated
        } = this.state;
        if (card) {
            return (
                <View style={{
                            ...
                            <View style={[Styles.flex1, Styles.p10]}>
                                ...
                                <ScrollView persistentScrollbar={true}>
                                    <View
...

                                        {
                                            card.editTollBill
                                                ...
                                                <TouchableOpacity
                                                    onPress={() => {
                                                        this.setState({tempCardIndex: index, cardIndex: index}, () => {
                                                            this.useSelectedDataReport(card, 'TOLL_BILL_DETAILS')
                                                        })
                                                    }}
                                                    activeOpacity={0.7}
                                                    style={[Styles.row, Styles.mTop5]}>
                                                    <View
                                                        style={[Styles.bw1, card.tollBillAmount ? Styles.bcAsh : Styles.bcLightRed, Styles.br5, Styles.marH5, Styles.mBtm10]}>
                                                        <View
                                                            style={[card.tollBillAmount ? Styles.bgLBlueWhite : Styles.bgLPink, Styles.padV10, Styles.alignCenter, {
                                                                width: Dimensions.get('window').width / 3.8,
                                                                height: 55
                                                            }]}>
                                                            <Text
                                                                numberOfLines={1}
                                                                style={[Styles.f14, card.tollBillAmount ? Styles.cLightNavyBlue : Styles.cLightRed, Styles.aslCenter, Styles.ffRRegular]}>{card.tollBillAmount || '--'}</Text>
                                                        </View>
                                                        <View style={[Styles.bgWhite, Styles.padV10, Styles.aslCenter, {
                                                            height: 36
                                                        }]}>
                                                            <Text
                                                                style={[Styles.f12, Styles.cLightBlue, Styles.aslCenter, Styles.ffRRegular]}>Toll Bills</Text>
                                                        </View>
                                                        <View style={[Styles.posAbsolute, {
                                                            top: 46,
                                                            left: Dimensions.get('window').width / 8.5
                                                        }]}>
                                                            {Services.returnCardStatusIcon(tollBillDetailsUpdated)}
                                                        </View>
                                                    </View>
                                                </TouchableOpacity>
                                                :
                                        ...
                                        {
                                            card.requireVehicleChangeSelection
                                                ?
                                                <TouchableOpacity
                                                    onPress={() => {
                                                        this.setState({tempCardIndex: index, cardIndex: index}, () => {
                                                            this.useSelectedDataReport(card, 'VEHICLE_CHANGE_DETAILS')
                                                        })
                                                    }}
                                                    activeOpacity={0.7}
                                                    style={[Styles.row, Styles.mTop5]}>
                                                    <View
                                                        style={[Styles.bw1, vehicleChangeDetailsUpdated ? Styles.bcAsh : Styles.bcLightRed, Styles.br5, Styles.marH5, Styles.mBtm10]}>
                                                        <View
                                                            style={[vehicleChangeDetailsUpdated ? Styles.bgLBlueWhite : Styles.bgLPink, Styles.padV10, Styles.alignCenter, {
                                                                width: Dimensions.get('window').width / 3.8,
                                                                height: 55
                                                            }]}>
                                                            <Text
                                                                numberOfLines={1}
                                                                style={[Styles.f14, vehicleChangeDetailsUpdated ? Styles.cLightNavyBlue : Styles.cLightRed, Styles.aslCenter, Styles.ffRRegular]}>{card.vehicleRegNumber || '--'}</Text>
                                                        </View>
                                                        <View style={[Styles.bgWhite, Styles.padV10, Styles.aslCenter, {
                                                            height: 36
                                                        }]}>
                                                        ...
                                                        <View style={[Styles.posAbsolute, {
                                                            ...
                                                            {Services.returnCardStatusIcon(vehicleChangeDetailsUpdated)}
                                                        </View>
                                                    </View>
                                                </TouchableOpacity>
                                                :
                                                ...
                                                <TouchableOpacity
                                                    ...
                                                    <View
                                                        ...
                                                        <View style={[Styles.bgWhite, Styles.padV10, Styles.aslCenter, {
                                                            ...
                                                            <Text
                                                                style={[Styles.f12, Styles.cLightBlue, Styles.aslCenter, Styles.ffRRegular]}>Vehicle Image Details</Text>
                                                        </View>
                                                        <View style={[Styles.posAbsolute, {
                                                            top: 46,
                                                            left: Dimensions.get('window').width / 8.5
                                                    ...
                                                    onPress={() => {
                                                        if (card.role === 10) {
                                                            if ((card.attrs.requiresClientUserId === 'true' ? (clientUserIdDetailsUpdated) : true) &&
                                                                ...
                                                                (card.editTollBill ? tollBillDetailsUpdated : true) &&
                                                                (card.requireVehicleChangeSelection ? vehicleChangeDetailsUpdated : true) &&
    ...
    onSwiped = (type) => {
        ...
        if (type === 'left' || type === 'right' || type === 'top') {
            this.setState({
                ...
                finalShortCash: '',
                finalTollBillAmount:'',
                finalVehicleMappingId:'',finalVehicleMappingRegNo:'',
    ...
    useSelectedDataReport(item, selectedButton) {
        this.setState({
            ...
            tempVehicleMappingId:item.vehicleId,tempVehicleMappingRegNo:item.vehicleRegNumber,
            ...
            tempTollBillAmount:item.tollBillAmount ? JSON.stringify(item.tollBillAmount) : '0',
    ...
    storeFinalValues() {
        const {
            ...
            vehicleImageDetailsUpdated,tollBillDetailsUpdated,
            vehicleChangeDetailsUpdated,
            ...
            finalVehicleMappingId,finalVehicleMappingRegNo,tempVehicleMappingId,tempVehicleMappingRegNo,
            finalVehicleVerificationImageUrl,tempVehicleVerificationImageUrl,tempTollBillAmount,
            //lite user bank info
        ...
        }
        {
            shortCashDetailsUpdated
                ?
                tempData.shortCash = shortCashDetailsUpdated ? finalShortCash ? parseInt(finalShortCash) : 0 : shortCash ? JSON.parse(shortCash) : shortCash === '0' ? 0 : ''
                :
                null
        }
        {
...

        {
            tollBillDetailsUpdated
                ?
                tempData.tollBillAmount = finalTollBillAmount ? parseInt(finalTollBillAmount) : '' : tempTollBillAmount ? JSON.parse(tempTollBillAmount)
                    :
                    null
        }

        if (tempData.requireVehicleChangeSelection){
            if (vehicleChangeDetailsUpdated){
                tempData.vehicleId = vehicleChangeDetailsUpdated ? finalVehicleMappingId : tempVehicleMappingId
                tempData.vehicleRegNumber = vehicleChangeDetailsUpdated ? finalVehicleMappingRegNo : tempVehicleMappingRegNo
            }
        }
    ...
    render() {
        ...
        return (
            <View style={[Styles.flex1, Styles.bgWhite]}>
                                        ...
                                        selectedCardTripDetails
                                            ...
                                            <View
                                                ...
                                                <ScrollView
                                                    ...
                                                    {
                                                        selectedCardTripDetails.editTollBill
                                                            ?
                                                            <View>
                                                                <TouchableOpacity
                                                                    activeOpacity={0.7}
                                                                    onPress={() => {
                                                                        this.useSelectedDataReport(selectedCardTripDetails, 'TOLL_BILL_DETAILS')
                                                                    }}
                                                                    style={[Styles.row, Styles.padV20, Styles.padH15, Styles.jSpaceBet, Styles.bgLightWhite, Styles.OrdersScreenCardshadow]}>
                                                                    <View/>
                                                                    <Text
                                                                        style={[editButton === 'TOLL_BILL_DETAILS' ? Styles.fWbold : null, Styles.ffRRegular, Styles.f14, Styles.cBlack68]}>Toll Details</Text>
                                                                    <View style={[Styles.aslCenter, Styles.padH5]}>
                                                                        {Services.returnCardStatusIcon(tollBillDetailsUpdated)}
                                                                    </View>
                                                                </TouchableOpacity>
                                                    ...
                                                    {/*MLL REQU. Added in Shift Flow*/}
                                                    {
                                                        selectedCardTripDetails.requireVehicleChangeSelection
                                                            ?
                                                            <View>
                                                                <TouchableOpacity
                                                                    activeOpacity={0.7}
                                                                    onPress={() => {
                                                                        this.useSelectedDataReport(selectedCardTripDetails, 'VEHICLE_CHANGE_DETAILS')
                                                                    }}
                                                                    style={[Styles.row, Styles.padV20, Styles.padH15, Styles.jSpaceBet, Styles.bgLightWhite, Styles.OrdersScreenCardshadow]}>
                                                                    <View/>
                                                                    <Text
                                                                        style={[editButton === 'VEHICLE_CHANGE_DETAILS' ? Styles.fWbold : null, Styles.ffRRegular, Styles.f14, Styles.cBlack68]}>Vehicle Details</Text>
                                                                    <View style={[Styles.aslCenter, Styles.padH5]}>
                                                                        {Services.returnCardStatusIcon(vehicleChangeDetailsUpdated)}
                                                                    </View>
                                                                </TouchableOpacity>
                                                        ...
                                                        selectedCardTripDetails.requireVehicleImageDetails
                                                            ...
                                                            <View>
                                                                <TouchableOpacity
                                                                    ...
                                                                    <View/>
                                                                    <Text
                                                                        style={[editButton === 'VEHICLE_IMAGE_DETAILS' ? Styles.fWbold : null, Styles.ffRRegular, Styles.f14, Styles.cBlack68]}>Vehicle Image Details</Text>
                                                                    <View style={[Styles.aslCenter, Styles.padH5]}>
                                                                        {Services.returnCardStatusIcon(vehicleImageDetailsUpdated)}
                                                                    </View>
                                                                </TouchableOpacity>
                                                                                    ...
                                                                                    !this.state.showUnVerifiedTripData
                                                                                        ...
                                                                                        <View
                                                                                            ...
                                                                                            <TouchableOpacity
                                                                                                onPress={() => {
                                                                                                    let resp = {}
                                                                                                    resp = Utils.isValidNumberEnteredTripVerification(this.state.shortCash, 'Short Cash');
                                                                                                    if (resp.status === true) {
                                                                                                        this.setState({
...

                                                                                                {
                                                                                                    selectedCardTripDetails.supervisorPenalty === 0
                                                                                                        ...
                                                                                                        <TouchableOpacity
                                                                                                            onPress={() => {
                                                                                                                let resp = {}
                                                                                                                resp = Utils.isValidNumberEnteredTripVerification(this.state.penalty, 'Penalty Amount');
                                                                                                                if (resp.status === true) {
                                                                                ...
                                                                                editButton === 'EMPLOYEE_ID'
                                                                                    ...
                                                                                    editButton === 'LITE_USER_PAYMENT_DETAILS'
                                                                                        ...
                                                                                        <ScrollView
                                                                                            ...
                                                                                            <ScrollView
                                                                                                persistentScrollbar={true}
                                                                                                style={[{height: subEditHeightBy60 - 140}]}>
                                                                                                        ...
                                                                                                        <View
                                                                                                                ...
                                                                                                                })}/>
                                                                                                            {
                                                                                                                this.state.errorBeneficiaryIFSCcode ?
                                                                                                                    <Text style={[Styles.ffRRegular,Styles.cRed,{marginBottom: 2}]}>{this.state.errorBeneficiaryIFSCcode}</Text>
                                                                                                                    :
                                                                                            ...
                                                                                            <Text
                                                                                                style={[Styles.ffRRegular, Styles.f14, Styles.padV5, Styles.cRed]}>Note: For any changes contact respective OM's</Text>
                                                                                            {
                                                                                                !this.state.showUnVerifiedTripData
                                                                                                    ?
                                                                                                    <View
                                                                                                ...
                                                                                                editButton === 'PAYMENT_PLAN'
                                                                                                    ...
                                                                                                    <ScrollView
                                                                                                        ...
                                                                                                        <ScrollView
                                                                                                            ...
                                                                                                            <Text
                                                                                                                style={[Styles.ffRRegular, Styles.f14, Styles.pTop15, Styles.cRed]}>Note: For plan changes contact central team</Text>
                                                                                                    ...
                                                                                                    editButton === 'OPERATIONS_TYPE'
                                                                                                        ...
                                                                                                        editButton === 'VEHICLE_IMAGE_DETAILS'
                                                                                                            ...
                                                                                                            <View
                                                                                                                style={[Styles.flex1, Styles.p15]}>
                                                                                                                <Text
                                                                                                                    style={[Styles.ffRLight, Styles.f18, Styles.cBlack87]}>Vehicle Image Details</Text>
                                                                                                                <ScrollView
                                                                                                                    style={[{height: subEditHeightBy60 - 100}]}>
                                                                                                            ...
                                                                                                            :
                                                                                                            editButton === 'TOLL_BILL_DETAILS'
                                                                                                                ?
                                                                                                                <View
                                                                                                                    style={[Styles.flex1, Styles.p15]}>
                                                                                                                    <Text
                                                                                                                        style={[Styles.ffRLight, Styles.f18, Styles.cBlack87]}>Toll Details</Text>

                                                                                                                    <Text
                                                                                                                        style={[Styles.ffRRegular, Styles.f14, Styles.mTop5, Styles.cGrey33]}>Amount Entered by Fleet</Text>
                                                                                                                    ...
                                                                                                                    <ScrollView
                                                                                                                        ...
                                                                                                                        <View>
                                                                                                                            <View
                                                                                                                                ...
                                                                                                                                <Text
                                                                                                                                    style={[Styles.ffRMedium, Styles.f18, Styles.cGrey4F]}>{selectedCardTripDetails.dataBeforeUpdate.tollBillAmount}</Text>
                                                                                                                            </View>

                                                                                                                            <View style={[Styles.mTop5]}>
                                                                                                                                <TouchableOpacity
                                                                                                                                    style={[Styles.row, Styles.aslCenter]}
                                                                                                                                    disabled={!selectedCardTripDetails.tollBillUrl}
                                                                                                                                    onPress={() => {
                                                                                                                                        this.setState({
                                                                                                                                            imagePreview: true,
                                                                                                                                            imagePreviewURL: selectedCardTripDetails.tollBillUrl
                                                                                                                                        })
                                                                                                                                    }}>
                                                                                                                                    <Image
                                                                                                                                        onLoadStart={() => this.setState({imageLoading: true})}
                                                                                                                                        ...
                                                                                                                                        source={selectedCardTripDetails.tollBillUrl ? {uri: selectedCardTripDetails.tollBillUrl} : null}
                                                                                                                                    />
                                                                                                                                </TouchableOpacity>
                                                                                                                                {
                                                                                                                                    selectedCardTripDetails.tollBillUrl
                                                                                                                                        ?
                                                                                                                                        <MaterialIcons
                                                                                                                                            name="zoom-in"
                                                                                                                                            size={28}
                                                                                                                            ...
                                                                                                                            <TextInput
                                                                                                                                ...
                                                                                                                                onChangeText={(tempTollBillAmount)=>{this.setState({tempTollBillAmount})}}
                                                                                                                                value={this.state.tempTollBillAmount}
                                                                                                                            />
                                                                                                                        </View>
                                                                                                                        ...
                                                                                                                        !this.state.showUnVerifiedTripData
                                                                                                                            ...
                                                                                                                            <View
                                                                                                                                ...
                                                                                                                                <TouchableOpacity
                                                                                                                                    onPress={() => {
                                                                                                                                        let resp = {}
                                                                                                                                        resp = Utils.isValidNumberEnteredTripVerification(this.state.tempTollBillAmount,'Toll Amount');
                                                                                                                                        if (resp.status === true) {
                                                                                                                                            this.setState({
                                                                                                                                                finalTollBillAmount: this.state.tempTollBillAmount,
                                                                                                                                                tollBillDetailsUpdated: true,
                                                                                                                                                selectedButton: 'DONE'
                                                                                                                                            }, () => {
                                                                                                                                                this.storeFinalValues()
                                                                                                                                            })
                                                                                                                ...
                                                                                                                :
                                                                                                                editButton === 'VEHICLE_CHANGE_DETAILS'
                                                                                                                    ?
                                                                                                                    <ScrollView
                                                                                                                        style={[Styles.flex1, Styles.p15,]}>
                                                                                                                        <Text
                                                                                                                            style={[Styles.ffRLight, Styles.f18, Styles.cBlack87]}>Shift Vehicle Details</Text>
                                                                                                                        <ScrollView
                                                                                                                            style={[{height: subEditHeightBy60 - 100}]}>
                                                                                                                            <Text
                                                                                                                                style={[Styles.ffRRegular, Styles.f14, Styles.pTop15, Styles.cGrey33]}>Entered by Fleet</Text>
                                                                                                                            <View
                                                                                                                                ...
                                                                                                                                <Text
                                                                                                                                    numberOfLines={4}
                                                                                                                                    style={[Styles.ffRMedium, Styles.f16, Styles.cGrey4F]}>{selectedCardTripDetails.dataBeforeUpdate.vehicleRegNumber}</Text>
                                                                                                                            </View>

                                                                                                                            <Text
                                                                                                                                style={[Styles.ffRRegular, Styles.f14, Styles.pTop15, Styles.cGrey33]}>Update Shift Vehicle</Text>
                                                                                                                            <View>
                                                                                                                                <TouchableOpacity
                                                                                                                                    style={[Styles.aslCenter, Styles.bw1, Styles.bcLightBlue, Styles.mTop10, {
                                                                                                                                        width: subEditDetialsWidth,
                                                                                                                                    ...
                                                                                                                                    activeOpacity={0.7}
                                                                                                                                    onPress={() => {
                                                                                                                                        this.getSiteMappedVehiclesList(selectedCardTripDetails.userId,selectedCardTripDetails.shiftId,selectedCardTripDetails.siteId,selectedCardTripDetails.id)
                                                                                                                                    }}>
                                                                                                                                    <Text style={[  Styles.cGrey33, Styles.ffRMedium,Styles.f16,Styles.pRight20,Styles.padV3]}>{this.state.tempVehicleMappingRegNo ? this.state.tempVehicleMappingRegNo : 'Select a Vehicle'}</Text>
                                                                                                                                    <MaterialIcons name='expand-more' color='#9e9e9e' size={35}
                                                                                                                                                   style={{
                                                                                                                                                       position: 'absolute',
                                                                                                                                                       right: 2,
                                                                                                                            ...
                                                                                                                            !this.state.showUnVerifiedTripData
                                                                                                                                ...
                                                                                                                                <View
                                                                                                                                    ...
                                                                                                                                    <TouchableOpacity
                                                                                                                                        onPress={() => {
                                                                                                                                            let resp = {}
                                                                                                                                            resp = Utils.checkIsValueEmpty(this.state.tempVehicleMappingId, 'Please select a Vehicle');
                                                                                                                                            if (resp.status === true) {
                                                                                                                                                this.setState({
                                                                                                                                                    finalVehicleMappingId: this.state.tempVehicleMappingId,
                                                                                                                                                    finalVehicleMappingRegNo: this.state.tempVehicleMappingRegNo,
                                                                                                                                                    vehicleChangeDetailsUpdated: true,
                                                                                                                                                    selectedButton: 'DONE'
                                                                                                                                                }, () => {
                                                                                                                                                    this.storeFinalValues()
                                                                                                                                                })
                ...
                {/*MODAL for vehicle change selection*/}
                <Modal transparent={true}
                       visible={this.state.vehicleMappingSelectionModal}
                       animated={true}
                       animationType='slide'
                       onRequestClose={() => {
                           this.setState({vehicleMappingSelectionModal: false})
                       }}>
                    <View style={[Styles.modalfrontPosition]}>
                        {this.state.spinnerBool === false ? null : <CLoader/>}
                        <View
                            ...
                            <View style={[Styles.flex1]}>
                                <View style={Styles.aslCenter}>
                                    <Text
                                        style={[Styles.ffMbold, Styles.colorBlue, Styles.f20, Styles.m10, Styles.mBtm10]}>Select Vehicle</Text>
                                </View>
                                {this.state.vehicleMappingList.length > 0 ?
                                    <ScrollView
                                        persistentScrollbar={true}
                                        style={{height: Dimensions.get('window').height - 80}}>
                                        {
                                            this.state.vehicleMappingList.map((item, index) => {
                                                return (
                                                    <TouchableOpacity
                                                        key={index}
                                                        disabled={item.vehicleStatus !== 'ACTIVE'}
                                                        activeOpacity={0.7}
                                                        onPress={() => this.setState({
                                                            vehicleMappingSelectionModal: false,
                                                            tempVehicleMappingId: item.vehicleId,
                                                            tempVehicleMappingRegNo: item.vehicleNumber
                                                        })}
                                                        style={[Styles.padV10]}>
                                                        <Text style={[Styles.colorBlue, Styles.f16,
                                                            Styles.aslCenter, Styles.bw1, Styles.br25, Styles.txtAlignCen, Styles.padH5, Styles.padV10,
                                                            this.state.vehicleMappingId === item.vehicleId ? [Styles.cWhite, Styles.bgDarkRed, Styles.bw0] : [item.vehicleStatus !== 'ACTIVE' ? Styles.cAsh : Styles.colorBlue, item.vehicleStatus !== 'ACTIVE' ? Styles.bgLYellow : Styles.bgWhite, Styles.bw1],
                                                            {
                                                                width: 210
                                                            }]}>{item.vehicleNumber + ' (' + item.vehicleType + 'Wheeler)-' + item.vehicleStatus}</Text>
                                                    </TouchableOpacity>
                                                );
                                            })
                                        }
                                    ...
                                    :
                                    <View style={[Styles.aslCenter, Styles.mTop20]}>
                                        <Text style={[Styles.ffRMedium, Styles.f18, Styles.alignCenter,Styles.cBlack87]}>No Vehicles Found</Text>
                                    </View>
                                }
                            </View>
