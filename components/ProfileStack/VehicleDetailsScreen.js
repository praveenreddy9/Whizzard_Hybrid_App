...
//API CALL TO DELETE VEHICLE DETAILS
    ...
    returnUpdateVehicleModalDetails(){
        const {
            SelectedTab,
            checkProfileField,
            VehicleResp,
                                        ...
                                        <View style={[Styles.mBtm20]}>
                                            ...
                                            <View>
                                                ...
                                                <TouchableOpacity
                                                    ...
                                                    onPress={()=>{this.setState({showDateTimepicker:true, selectedDatePicker:'InsuranceExpiryDate'})}}
                                            ...
                                            {
                                                this.state.showDateTimepicker && this.state.selectedDatePicker === 'InsuranceExpiryDate'
                                                    ?
                                                    <RNDateTimePicker
                                            ...
                                            <View style={[Styles.mBtm20]}>
                                                ...
                                                <View>
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        onPress={()=>{this.setState({showDateTimepicker:true, selectedDatePicker:'PollutionExpiryDate'})}}
                                                        style={[Styles.marV5, Styles.mRt30, Styles.mLt40, Styles.brdrBtm1, Styles.row, Styles.jSpaceBet]}>
                                                        {
                                                ...
                                                {
                                                    this.state.showDateTimepicker && this.state.selectedDatePicker === 'PollutionExpiryDate'
                                                        ?
                                                        <RNDateTimePicker
                                                            timeZoneOffsetInMinutes={0}
                                                            style={[Styles.bgLBlueMix]}
                                                ...
                                                <View>
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        onPress={()=>{this.setState({showDateTimepicker:true, selectedDatePicker:'RoadTaxExpiryDate'})}}
                                                        style={[Styles.marV5, Styles.mRt30, Styles.mLt40, Styles.brdrBtm1, Styles.row, Styles.jSpaceBet]}>
                                                        {
                                                ...
                                                {
                                                    this.state.showDateTimepicker && this.state.selectedDatePicker === 'RoadTaxExpiryDate'
                                                        ?
                                                        <RNDateTimePicker
                                                            timeZoneOffsetInMinutes={0}
                                                            style={[Styles.bgLBlueMix]}
                                                    ...
                                                    <View>
                                                        ...
                                                        <View
                                                            ...
                                                            <Picker
                                                                ...
                                                                itemStyle={[Styles.f18, Styles.colorBlue]}
    ...
    setDatePicker = (event, date) => {
        ...
        if(selectedDatePicker === 'InsuranceExpiryDate'){
            this.setState({
                InsuranceExpiryDate: shiftDate,
                showDateTimepicker: false,
                errorInsuranceMessage: null
            });
        } else if (selectedDatePicker === 'RoadTaxExpiryDate') {
            this.setState({
                RoadTaxExpiryDate: shiftDate,
                showDateTimepicker: false,
                errorRoadTaxMessage: null
            });
        }else if (selectedDatePicker === 'PollutionExpiryDate'){
            this.setState({
                PollutionExpiryDate: shiftDate,
                showDateTimepicker: false,
                                                ...
                                                <View style={[Styles.row, Styles.mRt30, Styles.mLt40,]}>
                                                    <TextInput
                                                        style={[{textTransform: 'uppercase'}, Styles.colorBlue,
                                                            Styles.bw1, Styles.bcAsh, Styles.marV5, Styles.br5, Styles.bgWhite, Styles.padH10,Styles.padV10, Styles.aslCenter]}
                                                        autoCapitalize='characters'
                                                        placeholder='AA'
                                                        mode='outlined'
                                                        autoCompleteType='off'
                                                    ...
                                                    <Text
                                                        style={[Styles.f28, Styles.cBlk, Styles.ffMbold, Styles.aslCenter]}> - </Text>
                                                    <TextInput
                                                        style={[{textTransform: 'uppercase'}, Styles.colorBlue, Styles.bw1, Styles.bcAsh, Styles.marV5, Styles.br5, Styles.bgWhite, Styles.padH10,Styles.padV10, Styles.aslCenter]}
                                                        mode='outlined'
                                                        placeholder='12'
                                                        autoCompleteType='off'
                                                        placeholderTextColor='#EFF0FF'
                                                    ...
                                                    <Text
                                                        style={[Styles.f28, Styles.cBlk, Styles.ffMbold, Styles.aslCenter]}> - </Text>
                                                    <TextInput
                                                        style={[{textTransform: 'uppercase'}, Styles.colorBlue, Styles.bw1, Styles.bcAsh, Styles.marV5, Styles.br5, Styles.bgWhite, Styles.padH20,Styles.padV10, Styles.aslCenter]}
                                                        placeholder='1234'
                                                        keyboardType='numeric'
                                                        mode='outlined'
                                                        autoCompleteType='off'
    ...
    render() {
        const {
            ...
            VehicleData,
            canEditTextInput,
            ImagesArray,ShowUpdateVehicleDetailsModal,ShowAddVehicleDetailsModal
        } = this.state;
        return (
            <View style={[Styles.flex1, Styles.bgWhite]}>
                <OfflineNotice/>
                ...
                {
                    ShowUpdateVehicleDetailsModal
                        ?
                        this.returnUpdateVehicleModalDetails()
                        :
                        ShowAddVehicleDetailsModal
                            ?
                            this.returnAddVehicleModalDetails()
                            :
                            <View style={[Styles.flex1, Styles.bgWhite]}>
                                <Appbar.Header style={[Styles.defaultbgColor, {borderBottomWidth: 0}]}>
                                    <Appbar.BackAction onPress={() => this.props.navigation.goBack()}/>
                                    <Appbar.Content title="Vehicle Information"
                                            ...
                                            vehicleList.map((list) => {
                                                return (<View key={list.id}>
                                                        <Card style={[Styles.mBtm15, Styles.ProfileScreenCardshadow]}>
                                                            <Card.Title
                                                                title={list.model ? 'Vehicle-' + list.model : 'Vehicle'}
                                                                ...
                                                                left={() => <FontAwesome5 name="check-circle"
                                                                                                    size={32}
                                                                                                    color="#b3b3b3"/>}
                                                                right={() =>
