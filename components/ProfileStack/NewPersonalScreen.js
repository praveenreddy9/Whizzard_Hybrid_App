...
export default class NewPersonalScreen extends Component {
    ...
    saveOrUpdatePersonalInfo() {
        ...
        this.setState({spinnerBool: true}, () => {
            Services.AuthHTTPRequestForShiftFlow(apiUrl, 'PUT', data, function (response) {
    ...
    setDatePicker = (event, date) => {
        console.log('reached date picker function',event,date);
        ...
        // this.state.showDate && this.state.selectedDatePicker === 'spouseDOB'

        if (selectedDatePicker === 'spouseDOB') {
            this.setState({spouseDateOfBirth: shiftDate,showDate:false});
        } else if (selectedDatePicker === 'dateOfBirth') {
            this.setState({dateOfBirth: shiftDate,showDate:false});
        } else if (selectedDatePicker === 'drivingLicenseExpiryDate') {
            this.setState({drivingLicenseExpiryDate: shiftDate,showDate:false})
        } else if (selectedDatePicker === 'kidDOB') {
            this.setState({kidDOB: shiftDate,showDate:false})
        }
    };
    ...
    deleteUploadedImage(fieldName, fileName) {
        ...
        this.setState({spinnerBool: true}, () => {
            Services.AuthHTTPRequestForShiftFlow(deleteImageURL, 'POST', body, function (response) {
                                ...
                                <View style={{paddingLeft: 40}}>
                                        <View style={[Styles.row, Styles.mTop8]}>
                                            <View style={[Styles.row, Styles.aslCenter]}>
                                                <RadioButton.Android value="Male" disabled={this.state.UserFlow === 'NORMAL' ?
                                            ...
                                            <View style={[Styles.row, Styles.aslCenter]}>
                                                <RadioButton.Android value="Female" disabled={this.state.UserFlow === 'NORMAL' ?
                                                    !(canEditTextInput === false && this.state.gender === null) : !canEditTextInput}
                                                             status={this.state.gender === 'Female'?'Male' : 'unchecked'}
                        ...
                        <View style={[Styles.p20]}>
                            <View style={[Styles.mBtm20]}>
                                ...
                                <View style={{paddingLeft: 40}}>
                                        <View style={[Styles.row, Styles.mTop8]}>
                                            <View style={[Styles.row, Styles.aslCenter]}>
                                                <RadioButton.Android value="Single" disabled={this.state.UserFlow === 'NORMAL' ?
                                                    !(canEditTextInput === false && this.state.maritalStatus == null) : !canEditTextInput}
                                                             status={this.state.maritalStatus === 'Single'?'checked' : 'unchecked'}
                                                             onPress={()=>{this.setState({maritalStatus:'Single'})}}/>
                                                <Text
                                                    style={[Styles.ffMregular, Styles.padH5, Styles.aslCenter, Styles.f16]}>Single</Text>
                                            </View>
                                            <View style={[Styles.row, Styles.aslCenter]}>
                                                <RadioButton.Android value="Married" disabled={this.state.UserFlow === 'NORMAL' ?
                                                    !(canEditTextInput === false && this.state.maritalStatus == null) : !canEditTextInput}
                                                             status={this.state.maritalStatus === 'Married'?'checked' : 'unchecked'}
                                                             onPress={()=>{this.setState({maritalStatus:'Married'})}}/>
                                                <Text
                                    ...
                                    <View style={[Styles.mBtm20]}>
                                        ...
                                        <View style={{paddingLeft: 40}}>
                                            <TouchableOpacity
                                                ...
                                                onPress={() =>
                                                    this.setState({showDate: true,selectedDatePicker:'spouseDOB'})}
                                        ...
                                        <View style={[Styles.mBtm20]}>
                                            ...
                                            <View style={{paddingLeft: 40}}>
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => this.setState({showDate: true,selectedDatePicker: 'kidDOB'})}
                                                    style={[Styles.padV5, Styles.row, Styles.jSpaceBet, {
                                                        borderBottomColor: '#ccc',
                                                        borderBottomWidth: 1
                                                    }]}
                                                ...
                                                {
                                                    this.state.showDate && this.state.selectedDatePicker === 'kidDOB'
                                                        ?
                                                        <RNDateTimePicker
                                                            style={[Styles.bgLBlueMix]}
                                                            mode={'date'}
                                                    ...
                                                    <View style={[Styles.row, Styles.mTop8]}>
                                                        <View style={[Styles.row, Styles.aslCenter]}>
                                                            <RadioButton.Android value="Male"
                                                                         status={this.state.kidGender === 'Male'?'checked' : 'unchecked'}
                                                                         onPress={()=>{this.setState({kidGender:'Male'})}}/>
                                                            <Text
                                                                style={[Styles.ffMregular, Styles.padH5, Styles.aslCenter, Styles.f16]}>Male</Text>
                                                        </View>
                                                        <View style={[Styles.row, Styles.aslCenter]}>
                                                            <RadioButton.Android value="Female"
                                                                         status={this.state.kidGender === 'Female'?'checked' : 'unchecked'}
                                                                         onPress={()=>{this.setState({kidGender:'Female'})}}
                                                            />
                                                            <Text
                                                                style={[Styles.ffMregular, Styles.padH5, Styles.aslCenter, Styles.f16]}>Female</Text>
                                                        </View>
                            ...
                            <View style={[Styles.mBtm20]}>
                                ...
                                <View style={{paddingLeft: 40}}>
                                    <TouchableOpacity
                                        ...
                                        onPress={() => this.setState({showDate: true,selectedDatePicker:'dateOfBirth'})}
                                        style={[Styles.padV5, Styles.row, Styles.jSpaceBet, {
                                            borderBottomColor: '#ccc',
                                            borderBottomWidth: 1
                                        }]}
                                    ...
                                    {
                                        this.state.showDate && this.state.selectedDatePicker === 'dateOfBirth'
                                            ?
                                            <RNDateTimePicker
                                                style={[Styles.bgLBlueMix]}
                                                mode={'date'}
                                    ...
                                    MyProfileResp.aadharPicDetails
                                        ...
                                        <View
                                            ...
                                            <TouchableOpacity
                                                ...
                                                onPress={() => {
                                                    this.setState({
                                                        showAdharPopupModal:false,
                                                        backgroundModal:'showAdharPopupModal',
                                            ...
                                            <ActivityIndicator
                                                style={[Styles.ProfilePersonalInfoImageActivityIndicator]}
                                        ...
                                        <View
                                            ...
                                            <TouchableOpacity
                                                ...
                                                onPress={() => {
                                                    this.setState({
                                                        imagePreview: true,
                                                        showPanCardPopupModal:false,
                                                        backgroundModal:'showPanCardPopupModal',
    ...
    returnDrivingLicenseModalDetails(){
        const {canEditTextInput, checkProfileField, MyProfileResp} = this.state;
        return(
            <View style={[Styles.flex1, Styles.bgWhite, {
                width: Dimensions.get('window').width,
                            ...
                            <View style={[Styles.mBtm20]}>
                                ...
                                <View style={{paddingLeft: 40}}>
                                    <TouchableOpacity
                                        ...
                                        onPress={() => this.setState({showDate: true,selectedDatePicker:"drivingLicenseExpiryDate"})}
                                        style={[Styles.padV5, Styles.row, Styles.jSpaceBet, {
                                            borderBottomColor: '#ccc',
                                            borderBottomWidth: 1
                                        }]}
                                    ...
                                    {
                                        this.state.showDate && this.state.selectedDatePicker === 'drivingLicenseExpiryDate'
                                            ?
                                            <RNDateTimePicker
                                                style={[Styles.bgLBlueMix]}
                                                mode={'date'}
                                        ...
                                        <View
                                            ...
                                            <TouchableOpacity
                                                ...
                                                onPress={() => {
                                                    this.setState({
                                                        imagePreview: true,
                                                        showDlPopupModal:false,
                                                        backgroundModal:'showDlPopupModal',
    ...
    returnAddressFillingModalDetails(){
        const {canEditTextInput, checkProfileField, MyProfileResp} = this.state;
        return(
            <View style={[Styles.flex1, Styles.bgWhite, {
                width: Dimensions.get('window').width,
                            ...
                            <View style={[Styles.m15]}>
                                ...
                                <View style={[Styles.mBtm15]}>
                                    ...
                                    <View
                                        ...
                                        <Picker
                                            itemStyle={[Styles.ffMregular, Styles.f18, Styles.colorBlue]}
    ...
    handleBackFunctions(){
        ...
        if (backgroundModal === 'showAdharPopupModal'){
            this.setState({showAdharPopupModal:true})
        }else if (backgroundModal === 'showPanCardPopupModal'){
            this.setState({showPanCardPopupModal:true})
        }else if(backgroundModal === 'showDlPopupModal'){
            this.setState({showDlPopupModal:true})
        }
    ...
    render() {
        const {canEditTextInput, checkProfileField, MyProfileResp,
            showPersonalPopupModal,showFamilyPopupModal,showAdharPopupModal,showPanCardPopupModal,showDlPopupModal,showClothingPopupModal,showMapsModal} = this.state;
        return (
            <View style={[Styles.flex1, Styles.bgWhite]}>
                <OfflineNotice/>
                {this.renderSpinner()}
                ...
                {
                    showPersonalPopupModal
                    ?
                        this.returnPersonalModalDetails()
                        :
                        showFamilyPopupModal
                    ?
                            this.returnFamilyModalDetails()
                            :
                    showAdharPopupModal
                        ?
                        this.returnAdharModalDetails()
                        :
                        showPanCardPopupModal
                        ?
                            this.returnPanCardModalDetails()
                            :
                            showDlPopupModal
                            ?
                                this.returnDrivingLicenseModalDetails()
                                :
                                showClothingPopupModal
                                ?
                                    this.returnClothingModalDetails()
                                    :
                                    showMapsModal
                                    ?
                                        this.returnAddressFillingModalDetails()
                                        :
                        <View style={[Styles.flex1, Styles.bgWhite]}>
                                ...
                                <View style={[Styles.p10]}>
                                    <Card style={[Styles.mBtm15, Styles.ProfileScreenCardshadow]}
                                        ...
                                        <Card.Title title="Personal"
                                                    ...
                                                    left={() => <FontAwesome5 name="check-circle" size={32} color="#b3b3b3"/>}
                                                    right={() =>
                                    ...
                                    <Card style={[Styles.mBtm15, Styles.ProfileScreenCardshadow]}
                                        ...
                                        <Card.Title title="Address"
                                                    ...
                                                    right={() =>
                                                        <MaterialIcons
                                                            name={this.state.showAddressDropDwon ? "keyboard-arrow-down" : 'chevron-right'}
                                                            size={32} color="#000"
                                                            style={[Styles.bgLWhite, Styles.br15, Styles.mRt10]}/>
                                                    }
                                        />
                                                ...
                                                <View style={[Styles.marH20]}>

                                                    {
                                                        this.state.address
                                                            ...
                                                            <View>
                                                                <View
                                                                    style={[Styles.row, Styles.aitCenter, Styles.marV10]}>
                                                                    <View
                                                                        style={{marginRight: 10}}>{LoadSVG.homeIcon}</View>
                                                                    <Text
                ...
                <Modal
                    ...
                    onRequestClose={() => {this.setState({imagePreview: false, imagePreviewURL: ''})}}>
                    <View style={[Styles.modalfrontPosition]}>
                        <View style={[Styles.flex1, Styles.bgWhite, {
                            width: Dimensions.get('window').width,
                            height: Dimensions.get('window').height
                            ...
                            <Appbar.Header style={[Styles.bgDarkRed, Styles.jSpaceBet]}>
                                ...
                                <MaterialIcons name="close" size={32}
                                                        color="#fff" style={{marginRight: 10}}
                                                        onPress={() =>this.setState({imagePreview: false, imagePreviewURL: ''})}/>
                            </Appbar.Header>
