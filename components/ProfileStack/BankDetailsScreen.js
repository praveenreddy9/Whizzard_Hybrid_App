...
export default class BankDetailsScreen extends Component {
    ...
    returnUserBankInfo(){
        const {checkProfileField, canEditTextInput, MyProfileResp, panNumberDetails, userPanFound,showUserBankDetailsInfo} = this.state;
        return(
                                        ...
                                        <View>
                                                ...
                                                <View
                                                    ...
                                                    <TextInput
                                                        style={[
                                                            ...
                                                            Styles.bw1, Styles.bcAsh, Styles.marV5, Styles.br5, Styles.bgWhite, Styles.padH15,Styles.padV10,
                                                        ...
                                                        editable={this.state.IFSCverified === false ? true
                                                            :
                                                            ( Utils.checkBankValueEnteredToEditing(canEditTextInput,MyProfileResp.ifscCode))}
                                            ...
                                            <View>
                                                ...
                                                <TextInput
                                                    ...
                                                    autoCompleteType='off'
                                                    editable={ Utils.checkBankValueEnteredToEditing(canEditTextInput,MyProfileResp.bankName)}
                                                    autoCapitalize="none"
                                                    blurOnSubmit={false}
                                            ...
                                            <View>
                                                ...
                                                <TextInput
                                                    ...
                                                    autoCompleteType='off'
                                                    editable={ Utils.checkBankValueEnteredToEditing(canEditTextInput,MyProfileResp.branchName)}
                                                    autoCapitalize="none"
                                                    blurOnSubmit={false}
                                                    // keyboardType='numeric'
                                            ...
                                            <View>
                                                ...
                                                <TextInput
                                                    ...
                                                    multiline={true}
                                                    autoCompleteType='off'
                                                    editable={ Utils.checkBankValueEnteredToEditing(canEditTextInput,MyProfileResp.branchAddress) }
                                                    autoCapitalize="none"
                                                    blurOnSubmit={false}
                                                    // keyboardType='numeric'
                                            ...
                                            <View>
                                                ...
                                                <TextInput
                                                    ...
                                                    autoCompleteType='off'
                                                    editable={ Utils.checkBankValueEnteredToEditing(canEditTextInput,MyProfileResp.accountNumber)}
                                                    autoCapitalize="none"
                                                    blurOnSubmit={false}
                                                    keyboardType='numeric'
                                            ...
                                            <View>
                                                ...
                                                <View
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        // disabled={canEditTextInput && Utils.checkBankValueEnteredToEditing(MyProfileResp.accountType)}
                                                        disabled={Utils.checkBankValuePresentToEditing(canEditTextInput,MyProfileResp.accountType)}
                                                        onPress={() => {
                                            ...
                                            <View>
                                                <View style={[Styles.row, Styles.aitCenter, Styles.marV15]}>
                                                    ...
                                                    <TouchableOpacity
                                                        disabled={Utils.checkBankValuePresentToEditing(canEditTextInput,MyProfileResp.bankInfo)}
                                                        onPress={() => {
                                                ...
                                                MyProfileResp.bankInfo || MyProfileResp.otherBankProofDetails
                                                    ...
                                                    <View>
                                                        <View
                                                            ...
                                                            <TouchableOpacity
                                                                disabled={Utils.checkBankValuePresentToEditing(canEditTextInput,MyProfileResp.otherBankProofDetails)}
                                                                onPress={() => {
                                            ...
                                            <View>
                                                ...
                                                <TextInput
                                                    ...
                                                    autoCompleteType='off'
                                                    editable={ Utils.checkBankValueEnteredToEditing(canEditTextInput,MyProfileResp.beneficiaryName)}
                                                    autoCapitalize="none"
                                                    blurOnSubmit={false}
                                                    // keyboardType='numeric'
                                                    ...
                                                    <View>
                                                        ...
                                                        <TouchableOpacity style={[Styles.row, {right: 10}]}
                                                            // disabled={canEditTextInput === false && checkProfileField.beneficiary}
                                                                          disabled={canEditTextInput === false && !userPanFound}
                                                                        ...
                                                                        <View style={[Styles.flex1]}>
                                                                            ...
                                                                            <View>
                                                                                ...
                                                                                <View style={{paddingLeft: 40}}>
                                                                                    <TextInput
                                                                                        editable={!(canEditTextInput === false && checkProfileField.beneficiaryInfo.panNumber) && !userPanFound}
                                                                                        style={[{
                                                                                            textTransform: 'uppercase',
                                                                                            borderBottomWidth: 1,
                                                                            ...
                                                                            <View>
                                                                                ...
                                                                                <View
                                                                                    ...
                                                                                    <TextInput
                                                                                        style={[
                                                                                            {textTransform: 'uppercase'},
                                                                                            Styles.bw1, Styles.bcAsh, Styles.marV5, Styles.br5, Styles.bgWhite, Styles.padH15,Styles.padV10, userPanFound ? Styles.cDisabled : Styles.colorBlue]}
                                                                                        autoCapitalize='characters'
    ...
    render() {
        const {checkProfileField, canEditTextInput, MyProfileResp, panNumberDetails, userPanFound,
            showUserBankDetailsInfo,ShowAddBankDetailsModal} = this.state;
        return (
            <View style={[Styles.flex1, Styles.bgWhite]}>
                <OfflineNotice/>
                {this.renderSpinner()}
                {
                    ShowAddBankDetailsModal
                        ?
                        this.returnUserBankInfo()
                        :
                        <View style={[Styles.flex1, Styles.bgWhite]}>
                                ...
                                <View style={[Styles.p10]}>
                                    <Card style={[Styles.mBtm15, Styles.ProfileScreenCardshadow]}>
                                        <Card.Title title="Account Information"
                                                    ...
                                                    left={() => <FontAwesome5 name="check-circle" size={32}
                                                                                        color="#b3b3b3"/>}
                                                    right={() =>
                                                        <MaterialIcons name="chevron-right" size={32} color="#000"
                                                                       ...
                                                                       onPress={() => MyProfileResp
                                                                           ?
                                                                           this.setState({ShowAddBankDetailsModal: true,showUserBankDetailsInfo:true}, () => {
                                                                               this.checkBeneficaryDetails(MyProfileResp.beneficiaryInfo)
                                                                           }) : null
                                                                       }/>
                                                    }
