...
export default class VerificationSwippingCards extends React.Component {
    ...
    componentDidMount() {
        ...
        let swippingCardsFilters = this.props.navigation.state.params.swippingCardsFilters
        AsyncStorage.getItem('Whizzard:userRole').then((userRole) => {
            let tempRole = JSON.parse(userRole)
            self.setState({userRole: tempRole,swippingCardsFilters,showUnVerifiedTripData:swippingCardsFilters.showUnVerifiedTripData}, () => {
                self.getUnverifiedTripList()
            })
        })
    }
    ...
    errorHandling(error) {
        // console.log("trip cards error", error, error.response);
        const self = this;
        if (error.response) {
    ...
    getUnverifiedTripList() {
        const self = this;
        const {swippingCardsFilters} = self.state;
        let apiURL = Config.routes.BASE_URL + Config.routes.GET_UN_VERIFIED_TRIPS_ID;
        const body = {
            siteId: swippingCardsFilters.filterSiteId,
            reportDateStr: swippingCardsFilters.filterDate,
            tripType: swippingCardsFilters.filterTripType,
            requiredTrips: swippingCardsFilters.requiredTripFilter
        }
        ...
        if (card) {
            return (
                <View style={{
                    ...
                    <Appbar.Header style={[Styles.bgBlk,{height:0}]}>
                    ...
                    <View style={[Styles.row,Styles.jSpaceBet]}>
                        <Appbar.BackAction color={'#fff'} onPress={() => this.props.navigation.goBack()}/>
                                    ...
                                    <View style={[Styles.row, Styles.padH30, Styles.jSpaceBet, Styles.mTop10]}>
...

                                        {
                                            card.vehicleType
                                                ...
                                                <View style={[Styles.aslCenter]}>
                                                    <Image
                                                        style={[{height: 30, width: 30}, Styles.ImgResizeModeCenter]}
                                            ...
                                            editButton === 'CLIENT_USER_ID'
                                                ...
                                                <ScrollView style={[Styles.flex1, Styles.p15,]}>
                                                    ...
                                                    <ScrollView
                                                        ...
                                                        <TextInput
                                                            style={[Styles.aslCenter, Styles.bw1, Styles.bcLightBlue, Styles.mTop10, Styles.cGrey33, Styles.ffRMedium,Styles.tInputH40, {
                                                                width: subEditDetialsWidth,
                                                                fontSize: 16,
                                                                padding: 10
                                                            }]}
                                                    ...
                                                    <ScrollView
                                                        ...
                                                        <ScrollView
                                                            ...
                                                            <Text
                                                                ...
                                                                Trip Sheet ID</Text>
                                                            <TextInput
                                                                style={[Styles.aitStart, Styles.bw1, Styles.bcLightBlue, Styles.mTop10, Styles.cGrey33,Styles.tInputH40, {
                                                                    width: subEditDetialsWidth,
                                                                    fontSize: 16,
                                                                    padding: 10
                                                                }]}
                                                    ...
                                                    editButton === 'KILOMETER'
                                                        ...
                                                        <View
                                                            ...
                                                            <ScrollView
                                                                ...
                                                                <View>
                                                                    <Text
                                                                        ...
                                                                        Km</Text>
                                                                            <TouchableOpacity
                                                                                ...
                                                                                {Services.returnActivityIndicator(this.state.imageLoading)}
                                                                                    </View>
                                                                                    :
                                                                                    <Text
                                                                                    style={[{
                                                                    ...
                                                                    <TextInput
                                                                        style={[Styles.aitStart, Styles.bw1, Styles.bcLightAsh, Styles.mTop10, Styles.cGrey33, Styles.ffRMedium,Styles.tInputH40,
                                                                            {
                                                                                width: windowWidth / 2,
                                                                                fontSize: 16,
                                                                                padding: 10
                                                                ...
                                                                <View>
                                                                    ...
                                                                    <TextInput
                                                                        style={[Styles.aitStart, Styles.bw1, Styles.bcLightAsh, Styles.mTop10, Styles.ffRMedium, Styles.cGrey33,Styles.tInputH40, {
                                                        ...
                                                        editButton === 'PACKAGES'
                                                            ...
                                                            <View
                                                                ...
                                                                >
                                                                    {
                                                                        tempDeliveredPackages.map((item,index)=>{
                                                                            return(
                                                                                <View key={index}
                                                                                    ...
                                                                                    <View style={[Styles.row, Styles.jSpaceBet,]}>
                                                                                        <TouchableOpacity
                                                                                            style={[Styles.alignCenter,Styles.tInputH40,Styles.bw1, Styles.bgBlk, Styles.padH15]}
                                                                                        ...
                                                                                        >
                                                                                            <Text
                                                                                                style={[Styles.ffRRegular,Styles.cWhite, Styles.f20]}
                                                                                            >-</Text></TouchableOpacity>
                                                                                        <View>
                                                                                            <TextInput
                                                                                                style={[Styles.txtAlignCen, Styles.bw1, Styles.bcAsh, Styles.ffRMedium, Styles.cGrey33,Styles.tInputH40, {
                                                                                                    width: windowWidth / 6,
                                                                                                    fontSize: 16
                                                                                                }]}
                                                                                                selectionColor={"black"}
                                                                            ...
                                                                            <View style={[Styles.mTop5,Styles.mRt30]}>
                                                                                {
                                                                                    selectedCardTripDetails.supervisorPenalty === 0
                                                                                        ...
                                                                                        this.state.reasonsForPenalty
                                                                                            ...
                                                                                            this.state.showUnVerifiedTripData
                                                                                                ?
                                                                                                this.state.reasonsForPenalty.map((item,index)=>{
                                                                                                                ...
                                                                                                                <FlatList
                                                                                                                    ...
                                                                                                                    renderItem={({item, index}) =>
                                                                                                                        <View key={index} style={[Styles.row, Styles.aslStart]}>
                                                                                                                            <RadioButton.Android disabled={true} value={true} color={'red'}
                                                                                                                            status={'checked'}/>
                                                                                                                            <Text
                                                                                        ...
                                                                                        <View
                                                                                            ...
                                                                                            <View
                                                                                                ...
                                                                                                <RadioButton.Android
                                                                                                    ...
                                                                                                    disabled={true}
                                                                                                    value={'Now'}
                                                                                                status={this.state.liteUserPaymentType === 'Now' ? 'checked' : 'unchecked'}/>
                                                                                                <Text
                                                                                            ...
                                                                                            <View
                                                                                                ...
                                                                                                <RadioButton.Android
                                                                                                    ...
                                                                                                    disabled={true}
                                                                                                    value={'Later'}
                                                                                                    status={this.state.liteUserPaymentType === 'Later' ? 'checked' : 'unchecked'}/>
                                                                                                <Text
                                                                                        ...
                                                                                        this.state.liteUserPaymentType === 'Later'
                                                                                            ...
                                                                                            <View
                                                                                                ...
                                                                                                <Text
                                                                                                    ...
                                                                                                    Number</Text>
                                                                                                <TextInput
                                                                                                    style={[Styles.aslCenter, Styles.bw1, Styles.bcLightBlue, Styles.marV10, Styles.cGrey33, Styles.ffRMedium,Styles.tInputH40, {
                                                                                                        width: subEditDetialsWidth,
                                                                                                        fontSize: 16,
                                                                                                        padding: 10
                                                                                                    }]}
                                                                                    ...
                                                                                    <ScrollView
                                                                                        ...
                                                                                        <ScrollView
                                                                                            ...
                                                                                            <View
                                                                                                ...
                                                                                                <TextInput
                                                                                                    style={[Styles.bgWhite, Styles.mTop10, Styles.bw1,Styles.tInputH40]}
                                                                                                    isFocused="false"
    ...
    render() {
        return (
            <View style={[Styles.flex1, Styles.bgWhite]}>
                {this.renderSpinner()}
                <OfflineNotice/>
                {/*<Appbar.Header style={[Styles.bgWhite,{height:0}]}>*/}
                {/*    /!*<Appbar.BackAction onPress={() => this.props.navigation.goBack()}/>*!/*/}
                {/*    /!*<Text*!/*/}
                {/*    /!*    style={[Styles.ffRMedium, Styles.cLightWhite, Styles.aslCenter, Styles.f18]}>Trip*!/*/}
                {/*    /!*    Verification</Text>*!/*/}
                ...
                {
                    this.state.editTripDetailsModal
                        ?
                        this.returnEditTripDetails()
                        :
                        <View style={[Styles.flex1, Styles.bgWhite]}>
                            <View style={{
                                flex: 1,
                            ...
                            <ScrollView
...

                                {
                                    this.state.rejectReasonsList
                                        ?
                                        this.state.rejectReasonsList.map((item,index)=>{
                                                  return(
                                                      <View
                                                          key={index}
                                                          style={[Styles.row, Styles.mTop5]}>
                    ...
                    <View style={[Styles.modalfrontPosition]}>
                        ...
                        <View
                            ...
                            <View style={[Styles.flex1]}>
                                <View style={Styles.aslCenter}>
                                    <Text
                                        style={[Styles.fWbold, Styles.colorBlue, Styles.f20, Styles.m10, Styles.mBtm10]}>Select
