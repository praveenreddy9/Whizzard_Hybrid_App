...
const routes = {
    ...
    // BASE_URL: "http://192.168.0.135:8090",  //SAI OFFICE IP Tech#2
    ...
    // BASE_URL: "http://mobileapi.whizzarard.in",  // New Server live URL
    // BASE_URL: "http://mllapi.whizzard.in",  // New MLL Server URL
    // BASE_URL: "http://testing.whizzard.in",  // Test Server URL

    // SERVER_CONNECTION : 'QA',
    SERVER_CONNECTION : 'ADMIN',

    // BASE_URL: Platform.OS === 'ios' ? "https://testing.whizzard.in" : "http://testing.whizzard.in",   //NEW testing URL (13.233.126.214==>new IP)
    BASE_URL: Platform.OS === 'ios' ? "https://imobileapi.whizzard.in" : "http://mobileapi.whizzard.in",   //NEW LIVE URL

    // BASE_URL: Platform.OS === 'ios' ? "http://192.168.0.120:8090" : "http://192.168.0.120:8090",   //Jeevan IP
    // BASE_URL: Platform.OS === 'ios' ? "http://192.168.0.101:8090" : "http://192.168.0.101:8090",   //Sai IP
    ...
    // SOCKET_URL :Platform.OS === 'ios' ? io("https://qasocketapi.whizzard.in") : io("http://qasocketapi.whizzard.in"),
    // SOCKET_BASE_URL :Platform.OS === 'ios' ? "https://qasocketapi.whizzard.in" : "http://qasocketapi.whizzard.in",

    // SOCKET_URL : io("") ,
    // SOCKET_BASE_URL :"",

    imageSelectionFromGallery:true,  //start,EndShift,Lite User screens

    //notification screen -text color and approval flow
    //log attendance - filter,toggle, TAB buttons handling,
    //date picker changes at personal screen
    ...
    //At general,Identity //version,Build

    //IOS change Bundle version string (short) at Whizzard/Info for version clarity,if same test builds includes into same
    ...
    //if Node Modules are deleted fix drawer(interpole issue),pod install with UTI error(export LC_ALL=en_US.UTF-8),
    //check archive list at window/organiser


    //IOS podfile install commands
    ...
    FETCH_FLEET_PAYSLIP_DATA : '/api/v1/finalPayouts/getUserMonthlyShiftPayslipByMonthAndYear/',
    FETCH_STAFF_PAYSLIP_DATA : '/api/v1/paymentReport/getPayoutByMonth/',

    // FETCH_FLEET_PAYSLIP_DATA : '/api/v1/finalPayouts/getUserMonthlyShiftPaymentByPhoneNumber/01-2023/8977680991', //for fetching Fleet Payslips
    // FETCH_FLEET_PAYSLIP_DATA : '/api/v1/finalPayouts/getUserMonthlyShiftPaymentByPhoneNumber/', //for fetching Fleet Payslips
    // FETCH_FLEET_PAYSLIP_DATA : '/api/v1/finalPayouts/getUserMonthlyShiftPayslipByMonthAndYear/03/2021/6007853cceba2c9ce4abf12e',
    // FETCH_STAFF_PAYSLIP_DATA : '/api/v1/paymentReport/getPayoutByMonth/08/2023/647846fbceba2c266ac9d8cb', //for fetching Staff Payslips
    //for fetching Staff Payslips
    // FETCH_STAFF_PAYSLIP_DATA : '/api/v1/paymentReport/getPayoutByUserId/08/2023/647846fbceba2c266ac9d8cb', //for fetching Staff Payslips OLD
    ...
    DELETE_SELF_ACCOUNT: "/api/v1/user/deleteAccount",
    ...
    GET_VEHICLES_FOR_SITE_MAPPED: '/api/v1/vehicle/getMappedVehiclesForSiteAndUser?',
    ...
    GET_USER_LOG_STATUS: '/api/v1/userAttendanceLog/getUserAttendanceLogStatusNew/',  //to check log status scan,Leave,Remotely
    ...
    UPDATE_USER_ATTENDANCE_STATUS: '/api/v1/userAttendanceLog/updateUserAttendanceApprovedStatus',  //used for arrpoval/reject in notification
    TO_FETCH_USER_DAY_DURATION: '/api/v1/userAttendanceLog/getTotalDurationOfUser/',
    FETCH_OFFICE_HOLIDAYS_LIST: '/api/v1/userAttendanceLog/getAllHolidaysList',
    ...
    UPLOAD_ADHOC_USER_AADHAAR_PIC : "/api/v1/userShift/uploadAdhocUserAadharDocument/",
    ...
    UPDATE_RTO_STATUS : '/api/v1/orders/updateRTOStatus/',
